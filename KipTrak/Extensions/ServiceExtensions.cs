...
public static class ServiceExtensions
{
    ...
    public static void ConfigureBlobService(this IServiceCollection services) => 
    ...
    { 
        ...
        { 
            s.SwaggerDoc("v1", new OpenApiInfo { Title = "KipTrak API", Version = "v1" });  
